...
import Listeners.ChessBoardMouseListener;
...
public class ChessBoard extends JPanel{
    ...
    public Game game;
    public ChessBoardMouseListener ml;
...
//---------------------------------------------------------------------------------------------------------------
    ...
    public void DrawImage(Graphics g, Game game,boolean Player,int bitNum, int PieceSerial)
    {
        ...
        ImageIcon piece= new ImageIcon( getClass().getResource("/mychess/images/"+Color+Piece+".png"));  
